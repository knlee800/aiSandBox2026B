...
class T6IdentityFreshness(Base):
    ...
    def test_t6_pm2_home_and_daemon_pid_checks(self):
        ...
        self.assertFalse("/home/a/.pm2" in out, "stdout leaked fixture pm2_home /home/a/.pm2")
        self.assertFalse("/home/a/.pm2" in err, "stderr leaked fixture pm2_home /home/a/.pm2")
        self.assertFalse("/home/b/.pm2" in out, "stdout leaked fixture pm2_home /home/b/.pm2")
        self.assertFalse("/home/b/.pm2" in err, "stderr leaked fixture pm2_home /home/b/.pm2")
        ...
        rc, out, err = run_cli(only_obs.args())
        report = parse_report(out)
        self.assertEqual(rc, 0)
        self.assertFalse(report["identity"]["pm2_home_checked"])
        self.assertFalse(report["identity"]["daemon_pid_checked"])
...
class T10Bytes(Base):
    ...
    def test_t10_output_mode_0600_and_output_exists(self):
        ...
        self.assertEqual(sorted(os.listdir(fx.directory)), ["jlist.json", "normalized.json", "observation-meta.json", "reference.json", "report.json"])
