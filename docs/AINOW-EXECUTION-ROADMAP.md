...
| 8 | AGENT-PLATFORM-04 | Multi-Builder Runtime Topology Plan | **COMPLETE and LOCKED — 2026-07-07.** All 4 steps complete. Topology plan: `docs/AGENT-PLATFORM-04-MULTI-BUILDER-TOPOLOGY-PLAN.md`. Role+profile identity model (agentRole + builderProfileId), 1:1 session/container isolation, per-builder harness config with global fallback, session-scoped preview/checkpoint. AGENT-HARNESS-07 next recommended (not registered). AGENT-HARNESS-06C remains deferred. See `docs/AGENT-PLATFORM-04-CHECKPOINT.md`. |
| 9 | Beta preparation | Beta readiness checklist | After Billing foundation and multi-builder topology |

---

## 4. Current Next Task

**AGENT-PLATFORM-04 — COMPLETE and LOCKED (2026-07-07).** Multi-Builder Runtime Topology Plan. All 4 steps complete. Architecture/planning/governance only — no implementation, no harness activation, no frontend/backend code changes. Topology plan at `docs/AGENT-PLATFORM-04-MULTI-BUILDER-TOPOLOGY-PLAN.md`. Checkpoint at `docs/AGENT-PLATFORM-04-CHECKPOINT.md`. Defines role+profile identity model (agentRole + builderProfileId), 1:1 session/container isolation per builder profile, per-builder harness config resolution with global fallback, session-scoped preview/checkpoint, Builder-only harness (non-Builder agents use lightweight runtime). AGENT-HARNESS-07 is the next recommended task (not yet registered). AGENT-HARNESS-06C remains deferred until after AGENT-HARNESS-07. BILLING-READY-03 is COMPLETE and LOCKED.

**Next recommended task:** AGENT-HARNESS-07 — Per-Builder Harness Config Adapter. Not registered. Must be registered before implementation begins. Must be implemented before AGENT-HARNESS-06C activates. See `docs/AGENT-PLATFORM-04-MULTI-BUILDER-TOPOLOGY-PLAN.md` section 7 for adapter requirements.
...
**AGENT-PLATFORM-04 sequencing (COMPLETE and LOCKED — 2026-07-07):** AGENT-PLATFORM-04 — Multi-Builder Runtime Topology Plan is COMPLETE and LOCKED. Topology plan at `docs/AGENT-PLATFORM-04-MULTI-BUILDER-TOPOLOGY-PLAN.md`. Checkpoint at `docs/AGENT-PLATFORM-04-CHECKPOINT.md`. AGENT-HARNESS-07 is now the next recommended task (not yet registered). AGENT-HARNESS-06C remains deferred until after AGENT-HARNESS-07. Multi-builder collaboration/runtime orchestration deferred until after AGENT-HARNESS-06C. Do not edit AGENT-PLATFORM-00.
