...
| 21e | BILLING-READY-05 | Stripe / Payment Provider Integration, Subscription Lifecycle, Credit Top-Up | **ACTIVE — Steps 1–2 COMPLETE (2026-07-13). Step 3 IN PROGRESS via child slices.** HIGH risk — 4-step loop. Step 2 COMPLETE — Stripe selected — split into 05A–05G approved by Keith 2026-07-13. BILLING-READY-05A COMPLETE and LOCKED (2026-07-15). BILLING-READY-05B next recommended, not registered. BILLING-READY-05C/05D/05E/05F/05G planned only, not registered. See `docs/BILLING-READY-05-PAYMENT-PROVIDER-READINESS-REVIEW.md`. AGENT-HARNESS write canary remains a separate track. |
...
**NEXT RECOMMENDED (not registered): BILLING-READY-05B — Customer / Subscription Persistence.** Not registered. Requires Keith explicit approval before registration. Scope: `webhook_events` and `credit_grants` TypeORM entities, `subscriptions` TypeORM entity, migrations, repositories, unit tests. No webhook endpoint, no live provider calls.

**ACTIVE (parent): BILLING-READY-05 — Stripe / Payment Provider Integration, Subscription Lifecycle, Credit Top-Up — 2026-07-13.** HIGH risk — 4-step loop — Steps 1–2 COMPLETE. Step 3 IN PROGRESS via child slices. 05A COMPLETE and LOCKED (2026-07-15). Step 2 COMPLETE (Payment Provider Readiness / Source-Path Review — 2026-07-13). Stripe selected. Split into 05A–05G approved by Keith 2026-07-13. BILLING-READY-05B/05C/05D/05E/05F/05G planned only and not registered. AGENT-HARNESS write canary remains a separate track. See `TASKS.md` — BILLING-READY-05.
...
| 21e | BILLING-READY-05 | Stripe / Payment Provider Integration, Subscription Lifecycle, Credit Top-Up (**ACTIVE — Steps 1–2 COMPLETE (2026-07-13). Step 3 IN PROGRESS via child slices.** HIGH risk — 4-step loop. Step 2 COMPLETE — Stripe selected — split into 05A–05G approved by Keith 2026-07-13. BILLING-READY-05A COMPLETE and LOCKED (2026-07-15). BILLING-READY-05B next recommended, not registered. BILLING-READY-05C/05D/05E/05F/05G planned only, not registered. AGENT-HARNESS write canary remains a separate track.) |
| 21e-i | BILLING-READY-05A | Provider Configuration / Contracts / Readiness | (**COMPLETE and LOCKED — 2026-07-15.** HIGH risk — 4-step child-slice loop — all 4 steps complete. First child slice of BILLING-READY-05. 4 production files + 3 test files. 79 tests PASS. TypeScript clean. No Stripe SDK. No provider API calls. No env changes. No migrations. No frontend. Checkpoint: `docs/BILLING-READY-05A-CHECKPOINT.md`. AGENT-HARNESS write canary remains a separate track.) |
