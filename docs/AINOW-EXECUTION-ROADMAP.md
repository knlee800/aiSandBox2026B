...
| 9 | AGENT-HARNESS-07 | Per-Builder Harness Config Adapter | **ACTIVE — 2026-07-07.** AGENT-HARNESS-07A COMPLETE and LOCKED (2026-07-07): backend builder profile registry + adapter contract. See `docs/AGENT-HARNESS-07A-CHECKPOINT.md`. **AGENT-HARNESS-07B COMPLETE and LOCKED (2026-07-07): Worker Integration + Resolved Config Flow.** See `docs/AGENT-HARNESS-07B-CHECKPOINT.md`. AGENT-HARNESS-07C (validation/checkpoint — future, not registered). AGENT-HARNESS-06C remains deferred until AGENT-HARNESS-07 completes. |
| 10 | Beta preparation | Beta readiness checklist | After Billing foundation and multi-builder topology |

---

## 4. Current Next Task

**AGENT-HARNESS-07B — COMPLETE and LOCKED (2026-07-07).** Worker Integration + Resolved Config Flow. All 4 steps complete. `AiExecutionJob` and `AgentHarnessRunRequestV1` extended with optional identity fields. `resolveBuilderHarnessConfig()` wired into `WorkerProcessor` before harness route decision. Resolved config used throughout harness branch (ToolDispatcher, handlers, loop options, audit, checkpoint gate). Global fallback preserved. Plain path unchanged. 33 suites / 629 tests passed. Typecheck and build clean. See `docs/AGENT-HARNESS-07B-CHECKPOINT.md`.

**AGENT-HARNESS-07 — ACTIVE (2026-07-07).** Per-Builder Harness Config Adapter. AGENT-HARNESS-07A COMPLETE and LOCKED (2026-07-07): backend builder profile contracts (`BuilderHarnessProfileV1`, `BuilderProfileV1`, adapter contracts), static default builder profile registry (`builder-default` — preserves current single-builder behavior), and pure `resolveBuilderHarnessConfig` adapter (platform approval floor enforcement, `allowArbitraryShell` veto, per-field override/default tracking, resolution metadata). 6 source files + 1 test-only blocker fix. 32 suites / 594 tests passed. See `docs/AGENT-HARNESS-07A-CHECKPOINT.md`. AGENT-HARNESS-07B COMPLETE and LOCKED (2026-07-07). See `docs/AGENT-HARNESS-07B-CHECKPOINT.md`. AGENT-HARNESS-07C (validation/checkpoint — future, not yet registered). AGENT-HARNESS-06C remains deferred until AGENT-HARNESS-07 is COMPLETE and LOCKED.

**Recommended next task: AGENT-HARNESS-07C — Validation/Regression Matrix and Checkpoint.** Not yet registered. Do not register until explicitly approved by Keith.
...
**AGENT-PLATFORM-04 sequencing (COMPLETE and LOCKED — 2026-07-07):** AGENT-PLATFORM-04 — Multi-Builder Runtime Topology Plan is COMPLETE and LOCKED. Topology plan at `docs/AGENT-PLATFORM-04-MULTI-BUILDER-TOPOLOGY-PLAN.md`. Checkpoint at `docs/AGENT-PLATFORM-04-CHECKPOINT.md`. AGENT-HARNESS-07 is ACTIVE (registered 2026-07-07); AGENT-HARNESS-07A COMPLETE and LOCKED (2026-07-07); AGENT-HARNESS-07B COMPLETE and LOCKED (2026-07-07) — see `docs/AGENT-HARNESS-07B-CHECKPOINT.md`; AGENT-HARNESS-07C future/not registered. AGENT-HARNESS-06C remains deferred until after AGENT-HARNESS-07. Multi-builder collaboration/runtime orchestration deferred until after AGENT-HARNESS-06C. Do not edit AGENT-PLATFORM-00.
