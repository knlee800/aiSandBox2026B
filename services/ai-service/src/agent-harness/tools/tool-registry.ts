...
export const AGENT_HARNESS_TOOL_DEFINITIONS_V1: readonly AgentHarnessToolRegistryDefinitionV1[] =
  Object.freeze([
    ...
    },
    {
      ...
      outputSchema: {
        ...
        schema: {
          type: 'object',
          additionalProperties: false,
          required: ['command', 'success', 'exitCode', 'stdout', 'stderr', 'timedOut', 'truncated', 'durationMs'],
          properties: {
            command: { type: 'string' },
      ...
      allowedScopes: ['workspace', 'repository'],
      auditEventTypes: ['tool-called', 'tool-completed'],
      tags: ['validation', 'allow-list-only', 'read-only'],
      implementationStatus: 'implemented',
    },
    {
      contractVersion: AGENT_HARNESS_CONTRACT_VERSION_V1,
    ...
    },
    {
      ...
      description: 'Run a headless browser smoke check against the session preview.',
      category: 'browser',
      inputSchema: {
        schemaType: 'json-schema',
        schema: {
