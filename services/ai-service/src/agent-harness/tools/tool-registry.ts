  ...
  Object.freeze([
    {
      ...
      tags: ['planned', 'metadata-only', 'workspace'],
    ...
    },
    {
      ...
      tags: ['planned', 'metadata-only', 'workspace', 'write', 'approval-required'],
      implementationStatus: 'contract-only',
    },
    {
      contractVersion: AGENT_HARNESS_CONTRACT_VERSION_V1,
      ...
      allowedScopes: ['workspace'],
      auditEventTypes: ['tool-called', 'tool-approved', 'tool-completed'],
      tags: ['planned', 'metadata-only', 'workspace', 'delete', 'approval-required'],
      implementationStatus: 'contract-only',
    },
    {
      contractVersion: AGENT_HARNESS_CONTRACT_VERSION_V1,
