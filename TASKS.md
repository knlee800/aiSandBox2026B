...
40. UX-IA-39 — Relocate Build Targets to Preview Panel (COMPLETE and LOCKED — `docs/UX-IA-39-CHECKPOINT.md`)
...
- Reuse existing i18n keys (`workspace.buildTargets`, `workspace.buildTargetLabel`, `workspace.runBuild`, `workspace.building`) — no new keys.
